...
import {
  INITIAL_PLAYBACK,
  INITIAL_VOTING,
  useWinPlaybackBroadcaster as usePlaybackBroadcaster,
  useWinVotingBroadcaster as useVotingBroadcaster,
  type PlaybackState,
  type VotingState,
} from "@/lib/channels";
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-stone-300 bg-white text-xs">
      <div className="flex items-center gap-3">
        ...
        <span className="font-semibold tracking-wider">WIN ADMIN</span>
