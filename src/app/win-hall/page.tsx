...
import {
  useWinPlaybackPublisher as usePlaybackPublisher,
  useWinPlaybackSubscriber as usePlaybackSubscriber,
  useWinVotingPublisher as useVotingPublisher,
  type PlaybackState,
  type VotingState,
} from "@/lib/channels";
...
// The big yellow "WINNER" banner sits on top of every playback view on the
// win-hall page so the projector reads as a celebration screen.
function WinnerOverlay() {
  return (
    <div className="pointer-events-none fixed inset-x-0 top-8 z-50 flex justify-center">
      <div
        className="text-5xl sm:text-7xl md:text-8xl font-extrabold uppercase italic"
        style={{
          color: "#F5F019",
          ...
          fontWeight: 700,
          textShadow:
            "0 0 16px rgba(245, 240, 25, 0.85), 0 0 40px rgba(245, 200, 40, 0.55), 0 4px 22px rgba(0,0,0,0.75)",
        }}
      >
        WINNER
      </div>
